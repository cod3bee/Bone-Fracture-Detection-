...
sigma = 2.2
f='C:\\Users\\prashantkumar_g\\Desktop\\KavinXray\\femur_broken.jpg'
#f = 'C:\\Users\\prashantkumar_g\\AppData\\Local\\Programs\\Python\\Python37-32\\cannynewmag.jpg'
...
#print(sobeloutdir)
gradxx=numpy.square(gradx)
gradyy=numpy.square(grady)
sumofgrad=gradxx+gradyy
G=numpy.sqrt(sumofgrad)
print(G)
div=numpy.divide(grady,gradx)
print(div)
angle=scipy.arctan2(grady, gradx)
print('angle')
print(angle)
x = numpy.angle(angle,deg=True)
print('x')
print(x)
if (x.any()>145):
    print('not broken')
